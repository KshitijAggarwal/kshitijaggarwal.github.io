...
However traditional RNN networks are not very good at remembering things because of sigmoid/tanh activation function which is not very good at transferring weight updates during backpropogation. Another reason for this is relatively simple formulation of recurrent nature of the network. The recurrent function might require something more powerful to rememeber previous inputs, than a simple adding mechanism followed by an activation function as showed in the equation above.
...
I hope that a lot was learnt while going throguh this blog post. If you have any comments/suggesstions or any doubt, please write it in the comments below.
